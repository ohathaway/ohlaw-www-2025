/* 
  This file is provided for reference purposes only. It has been converted
  to pure nested CSS via AI to fit with TailwindCSS 4.0's move to CSS-based
  theming instead of java/typescript themes. The CSS is imported by site.css
...
/**
  ...
  *
  * @checksum - 314eeeeb2b44962a0d2b10dadfc0df41a80db31875698236f6f0f2557a9214a1
  * @variables - radius=rounded,accentColor=blue,colorTemperature=neutral,spacing=2,scale=base,inputShadow=shadow-md,baseColorShade=600,borderShadeLightMode=400,borderShadeDarkMode=500,inputMaxWidth=max-w-[20em],tagRadius=rounded,swatchRadius=rounded
  * @theme - regenesis
  **/
...
const classes: Record<string, Record<string, boolean>> = {
  ...
  "family:text__inner": {
    ...
    "focus-within:!ring-slate-500": true,
    "focus-within:!border-slate-500": true,
