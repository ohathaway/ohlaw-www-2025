    ...
    <div class="service-content bg-white bg-opacity-10 backdrop-blur-sm rounded-lg p-8 mt-8 shadow-lg transition-all duration-500">
      <TransitionGroup name="fade" mode="out-in" tag="div">
        ...
        <div v-if="activeService === 'rebuilding'" key="rebuilding" class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <div>
            <h3 class="text-amber-300 text-3xl font-semibold mb-4">
              Starting Fresh
            </h3>
            <p class="text-slate-900 text-lg mb-6">
              Overcome financial challenges and build a strong foundation for your future.
            </p>
            <div class="mb-6">
              <h4 class="text-slate-700 font-medium mb-2">
                How we can help:
              </h4>
          ...
          <div class="hidden md:block">
            <div class="relative h-60 rounded-lg overflow-hidden">
              ...
              <div class="absolute inset-0 bg-primary-900 opacity-40" />
            </div>
          </div>
        </div>
        ...
        <div v-if="activeService === 'building'" key="building" class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <p class="text-slate-900 text-lg mb-6">
              Create the right legal structure for your business idea to thrive and grow.
            </p>
            <div class="mb-6">
              <h4 class="text-slate-700 font-medium mb-2">
                How we can help:
        ...
        <div v-if="activeService === 'growing'" key="growing" class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <p class="text-slate-900 text-lg mb-6">
              Establish an organization that makes a lasting difference in your community.
            </p>
            <div class="mb-6">
              <h4 class="text-slate-700 font-medium mb-2">
                How we can help:
        ...
        <div v-if="activeService === 'protecting'" key="protecting" class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <p class="text-slate-900 text-lg mb-6">
              Ensure your family and assets are protected for generations to come.
            </p>
            <div class="mb-6">
              <h4 class="text-slate-700 font-medium mb-2">
                How we can help:
