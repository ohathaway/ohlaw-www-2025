<template>
  <section id="lines-of-business" class="py-12 bg-primary-100">
    <div class="container mx-auto px-4">
      <h1 class="text-5xl text-center my-5">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        >
          ...
          >
            <div class="absolute inset-0 bg-primary-800 opacity-40 hover:opacity-50 transition-opacity" />
          </div>
          ...
          <div class="relative h-full p-6 flex flex-col justify-between z-10">
            ...
            <div class="flex justify-between items-center">
              ...
              >
                ...
                <i :class="expandedService === service.id ? 'pi pi-chevron-up' : 'pi pi-chevron-down'" />
              </button>
            </div>
          </div>
        </div>
