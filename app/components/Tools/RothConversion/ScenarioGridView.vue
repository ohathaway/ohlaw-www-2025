        ...
        <div v-else class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 max-w-6xl mx-auto">
          ...
          >
            ...
            <template #content>
              <div class="space-y-4 text-center py-4">
                <div class="mx-auto w-16 h-16 bg-primary-100 rounded-full flex items-center justify-center">
                  <i class="pi pi-plus text-primary-600 text-2xl"></i>
                </div>
                <div>
                  <p class="text-primary-700 font-medium mb-2">Create {{ store.customScenarios.length === 1 ? 'a second' : 'a third' }} custom scenario with different assumptions</p>
                  <p class="text-primary-600 text-sm">
