<template>
  <div class="booking-landing">
      ...
      <div class="container mx-auto px-4">
        <div class="max-w-3xl mx-auto text-center">
          ...
          <p class="text-xl mb-4">
            Thank you for scheduling with OH Law.
          </p>
        ...
        <div v-if="appointmentType === 'estate-plan-education'" class="mt-10 max-w-3xl mx-auto text-center">
          ...
          <p class="mb-6">
            We need you to do some homework.
          </p>

          <div class="flex justify-center gap-8 mb-6">
            <a
              class="flex flex-col items-center px-8 py-4 border border-primary-500 rounded-md hover:bg-primary-50 transition-colors"
              href="https://app.lawmatics.com/forms/share/d57bebf9-6e6b-4966-b019-bb97036f8594"
              target="_blank"
            >
              <i class="pi pi-desktop text-5xl mb-2 text-primary-600" />
            ...
            >
              <i class="pi pi-file-pdf text-5xl mb-2 text-primary-600" />
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div>
            <h2 class="text-2xl md:text-3xl font-semibold mb-6 relative pb-4 text-center lg:text-left">
              What to Expect
              <span class="absolute bottom-0 left-1/2 lg:left-0 w-16 h-1 bg-primary-500 transform -translate-x-1/2 lg:translate-x-0" />
            </h2>
            ...
            <div v-if="pageContent.expectationsList" class="mt-8">
              <ul class="space-y-4">
                <li v-for="(item, index) in pageContent.expectationsList" :key="index" class="flex items-start">
                  <i class="pi pi-check-circle text-green-500 mr-3 mt-1" />
                  <span>{{ item }}</span>
                </li>
              </ul>
            </div>
    ...
    <!-- What to Bring -->
    <section v-if="pageContent.preparations" class="py-12 bg-slate-100">
      <div class="container mx-auto px-4">
        <h2 class="text-2xl md:text-3xl font-semibold mb-2 text-center relative pb-4">
          How to Prepare
          <span class="absolute bottom-0 left-1/2 w-16 h-1 bg-primary-500 transform -translate-x-1/2" />
        </h2>
        <h4 class="text-xl text-center italic mb-10">
          Do The Homework
        </h4>
        ...
        <div class="max-w-5xl mx-auto">
          <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div
              v-for="(prep, index) in pageContent.preparations"
              :key="index"
              class="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow p-6 text-center"
            >
              <i class="pi text-orange-900" :class="prepIcon(prep.icon)" style="font-size: 3rem" />
    ...
    <!-- FAQ Section -->
    <section v-if="pageContent.faq && pageContent.faq.length" class="py-12">
      <div class="container mx-auto px-4">
        ...
        <div class="max-w-3xl mx-auto">
          <FaqAccordion :faq-items="pageContent.faq" />
        </div>
      </div>
    </section>
    ...
    <section class="py-12 text-center bg-primary-50">
      <div class="container mx-auto px-4">
        <h2 class="text-2xl md:text-3xl font-semibold mb-4">
          {{ pageContent.ctaHeading || 'Next Steps' }}
        </h2>
        ...
        <div class="flex flex-wrap justify-center gap-4">
          ...
          <NuxtLink
            v-if="pageContent.ctaSecondaryButton"
