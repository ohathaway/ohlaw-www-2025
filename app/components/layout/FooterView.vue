        ...
        <div>
          ...
          <ClientOnly>
            <ul class="flex flex-col sm:flex-row sm:inline-flex list-none pl-0 gap-2 sm:gap-0">
              ...
              <!--
              <li class="my-2">
                <font-awesome-icon icon="far fa-calendar-days" fixed-width></font-awesome-icon>
                &nbsp;&nbsp;&nbsp;&nbsp;
                <a
                  class="text-white"
                  href="#"
