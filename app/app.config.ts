export default defineAppConfig({
  ...
  quizzes: {
    reports: {
      ...
      staticTools: [
        {
          id: 'kids-protection-plan',
          title: 'Kids Protection Plan',
          description: 'Essential guide for protecting your children\'s future with proper legal documentation.',
          url: 'https://ohlawcolorado.com/resources/kids-protection-plan',
        ...
        },
        {
          ...
          description: 'Comprehensive checklist to ensure you haven\'t missed any important steps.',
          url: 'https://ohlawcolorado.com/resources/estate-planning-checklist',
          category: 'resource',
          priority: 2,
        },
        {
          ...
          description: 'Book a personalized consultation to discuss your estate planning needs.',
          url: 'https://booking.ohlawcolorado.com/new-client',
          category: 'booking',
          priority: 3,
        },
        {
          ...
          description: 'Find directions to our Fort Collins office and contact information.',
          url: 'https://ohlawcolorado.com/contact',
          category: 'contact',
          priority: 4,
        },
      ],
