        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <div class="order-2 md:order-1">
            <div class="p-4">
              ...
              <p class="mb-4">
                Like most families, it has been a long and winding road to where we are today. We were married in 2000, just after the <a
                  href="https://en.wikipedia.org/wiki/Year_2000_problem"
                  title="Y2k Problem"
                  target="_blank"
                  class="text-primary-600 hover:text-primary-800 underline"
                >Y2k bug</a> blew up (or maybe it didn't) all the world's computers. I was running IT departments for hospitals, and Michelle had just finished college.
              </p>
      ...
      <div class="container mx-auto px-4">
        <div class="max-w-4xl mx-auto text-center">
          <div class="p-6 border-l-4 border-r-4 border-white/30">
            <i class="pi pi-quote-right text-5xl mb-4 opacity-50" />
        ...
        <div class="grid grid-cols-4 gap-8">
          <div class="col-span-4 md:col-span-3">
            <div class="p-4">
              ...
              <p class="mb-4">
                Shortly after I passed the bar, one of my clients asked me to join their small, family-owned private equity firm. They bought and operated technology-forward healthcare service companies, and it seemed like a natural fit.
              </p>
              <p class="mb-4">
          ...
          <div class="col-span-4 md:col-span-1 md:me-8">
            <div class="bg-stone-700 text-white p-4 rounded-lg h-full shadow-lg">
              ...
              <p class="mb-4">
                We've owned multiple businesses and understand the challenges entrepreneurs face because we've lived them.
              </p>
              <hr class="my-3 border-white/30">
              <p class="italic mb-0">
                Our experience building businesses gives us a unique perspective on the practical legal needs of small business owners.
              </p>
            </div>
          </div>
        </div>
    ...
    <section id="pfl" class="py-16 bg-slate-100">
      <div class="container mx-auto px-4">
        <div class="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
          ...
          <div class="md:col-span-7">
            <div class="p-4">
              ...
              <p class="mt-4">
                While we've always aimed to make legal services affordable and accessible to everyone—from <span class="italic">the outhouse to the penthouse</span>—the PFL system has equipped us with additional systems and processes to deliver even more value to the families we serve.
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="mt-12 text-center">
          <h5 class="text-xl italic font-semibold md:w-[65%] mx-auto mb-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="bg-white p-6 rounded-lg shadow-md h-full text-center">
              <i class="pi pi-calendar text-5xl text-primary-500 mb-4" />
              <h4 class="text-xl font-semibold mb-3">
                3-Meeting Process
              </h4>
            ...
            <div class="bg-white p-6 rounded-lg shadow-md h-full text-center">
              <i class="pi pi-shield text-5xl text-primary-500 mb-4" />
              <h4 class="text-xl font-semibold mb-3">
                Proven Systems
              </h4>
            ...
            <div class="bg-white p-6 rounded-lg shadow-md h-full text-center">
              <i class="pi pi-sync text-5xl text-primary-500 mb-4" />
              <h4 class="text-xl font-semibold mb-3">
      ...
      <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div class="bg-white rounded-lg shadow-md overflow-hidden transition-transform hover:translate-y-[-5px] duration-300">
            <div class="p-6 h-[360px]">
              <div class="text-center mb-4">
                <i class="pi pi-arrow-circle-up text-5xl text-stone-500" />
              </div>
            ...
            <div class="bg-primary-700 text-white text-center py-3">
              <NuxtLink to="/services/bankruptcy" class="text-white hover:text-white/90 no-underline">
                Learn More <i class="pi pi-arrow-right ml-2" style="font-size: 1rem;" />
              </NuxtLink>
            </div>
          </div>
          ...
          <div class="bg-white rounded-lg shadow-md overflow-hidden transition-transform hover:translate-y-[-5px] duration-300">
            <div class="p-6 h-[360px]">
              <div class="text-center mb-4">
                <i class="pi pi-home text-5xl text-stone-500" />
              </div>
              <h3 class="text-xl font-semibold mb-4 text-center">
          ...
          <div class="bg-white rounded-lg shadow-md overflow-hidden transition-transform hover:translate-y-[-5px] duration-300">
            <div class="p-6 h-[360px]">
              <div class="text-center mb-4">
                <i class="pi pi-briefcase text-5xl text-stone-500" />
              </div>
              <h3 class="text-xl font-semibold mb-4 text-center">
          ...
          <div class="text-center">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mt-8">
              <div class="bg-white p-6 rounded-lg shadow-md text-center transition-all duration-300 hover:bg-slate-50">
                <i class="pi pi-wallet text-stone-500 mb-4" />
                <h4 class="text-xl font-semibold mb-3">
                  Fixed Fees
                </h4>
              ...
              <div class="bg-white p-6 rounded-lg shadow-md text-center transition-all duration-300 hover:bg-slate-50">
                <i class="pi pi-home text-5xl text-stone-500 mb-4" />
                <h4 class="text-xl font-semibold mb-3">
                  We Come To You
                </h4>
              ...
              <div class="bg-white p-6 rounded-lg shadow-md text-center transition-all duration-300 hover:bg-slate-50">
                <i class="pi pi-users text-5xl text-stone-500 mb-4" />
                <h4 class="text-xl font-semibold mb-3">
                  For Everyone
                </h4>
    ...
    <section class="py-16 bg-gradient-to-r from-primary-700 to-primary-900 text-white text-center">
      <div class="container mx-auto px-4">
        <div class="max-w-4xl mx-auto">
          ...
          <p id="sayings" class="mt-6 italic text-sm text-white/80">
