      ...
      <div class="container mx-auto px-4">
        <div class="flex justify-center mb-4">
          <div class="bg-white/20 p-4 rounded-full">
            <span class="text-5xl"><i class="pi pi-check-circle text-white" /></span>
          </div>
        </div>
        ...
        <p class="text-xl opacity-90">
          Thank you for your payment to OH Law
        </p>
      </div>
    </section>
      ...
      <div class="container mx-auto px-4">
        <div class="max-w-3xl mx-auto text-center">
          ...
          <p class="text-xl mb-4">
            We've received your payment and will process it promptly.
          </p>
          <div class="bg-stone-200 border border-stone-300 rounded-lg p-6 mb-6">
            <div class="flex items-start justify-center">
              <span class="text-lg"><i class="pi pi-info-circle text-stone-600 mt-1 mr-3 flex-shrink-0" /></span>
              <div class="text-left">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
          ...
          <div class="bg-white rounded-lg shadow-md overflow-hidden transition-transform hover:translate-y-[-5px] duration-300">
            <a href="tel:+19708183052" class="block no-underline text-slate-800 h-full">
              <div class="p-6 flex flex-col items-center text-center">
                <span class="text-4xl"><i class="pi pi-phone text-stone-600 mb-3" /></span>
          ...
          <div class="bg-white rounded-lg shadow-md overflow-hidden transition-transform hover:translate-y-[-5px] duration-300">
            <a href="sms://+19708185559" class="block no-underline text-slate-800 h-full">
              <div class="p-6 flex flex-col items-center text-center">
                <span class="text-4xl"><i class="pi pi-comment text-stone-600 mb-3" /></span>
          ...
          <div class="bg-white rounded-lg shadow-md overflow-hidden transition-transform hover:translate-y-[-5px] duration-300">
            <a href="mailto:contact@ohlawcolorado.com" class="block no-underline text-slate-800 h-full">
              <div class="p-6 flex flex-col items-center text-center">
                <span class="text-4xl"><i class="pi pi-envelope text-stone-600 mb-3" /></span>
    ...
    <section class="py-12 bg-slate-50">
      <div class="container mx-auto px-4">
        ...
        <p class="text-center text-slate-600 mb-10">
          Check out our latest insights from the team
        </p>
  ...
  <div v-else>
    <section class="relative py-12 bg-amber-500 md:py-16 text-center text-white">
      <div class="container mx-auto px-4">
        <div class="flex justify-center mb-4">
          <div class="bg-white/20 p-4 rounded-full">
            <span class="text-5xl"><i class="pi pi-exclamation-triangle text-white" /></span>
          </div>
        </div>
        <h1 class="text-3xl md:text-4xl font-bold mb-4">
    ...
    <section class="py-12 bg-slate-100">
      <div class="container mx-auto px-4">
        <div class="max-w-3xl mx-auto text-center">
          <h2 class="text-2xl md:text-3xl font-semibold mb-4">
            You've Reached the Payment Confirmation Page
          </h2>
          <p class="text-xl mb-6">
            This page is only shown after completing a payment through our secure payment portal.
          </p>
