<template>
  <div class="contact-us-container">
    ...
    <section id="schedule" class="py-16 bg-slate-200">
      <div ref="schedulingSection" class="container mx-auto px-4 relative">
      ...
      <div class="container mx-auto px-4">
        <div class="mb-8">
          ...
          <p class="max-w-4xl mx-auto text-center mb-8">
            ...
            <a
              href="https://www.officeevolution.com/"
            ...
            <strong>Just please
              <a href="#visit-us" class="text-primary-600 hover:text-primary-800 cursor-pointer" @click="openBookingModal">
                make an appointment
              </a>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8 items-start">
          <div class="md:col-span-1 order-first md:order-last">
            <div class="bg-stone-400 text-white p-4 rounded-lg shadow-lg">
              <p class="mb-4">
                These are the offices we use most frequently.
              </p>

              <Accordion value="0" :active-index="0" @update:value="handleAccordionChange">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <a :href="formatPhoneNumberForTel(phoneNumbers.voice)" class="block no-underline text-slate-800 h-full">
              <div class="p-6 flex flex-col items-center">
                <div class="text-center mb-4">
                  <i class="pi pi-phone text-5xl text-primary-600" />
                </div>
          ...
          <div class="bg-white rounded-lg shadow-md overflow-hidden transition-transform hover:translate-y-[-5px] duration-300">
            <a :href="formatPhoneNumberForSms(phoneNumbers.sms)" class="block no-underline text-slate-800 h-full">
              <div class="p-6 flex flex-col items-center">
                <div class="text-center mb-4">
                  <i class="pi pi-comment text-5xl text-primary-600" />
                </div>
          ...
          <div class="bg-white rounded-lg shadow-md overflow-hidden transition-transform hover:translate-y-[-5px] duration-300">
            <a :href="`mailto:${contactEmail}`" class="block no-underline text-slate-800 h-full">
              <div class="p-6 flex flex-col items-center">
                <div class="text-center mb-4">
                  <i class="pi pi-envelope text-5xl text-primary-600" />
                </div>
          ...
          <div class="bg-white rounded-lg shadow-md overflow-hidden transition-transform hover:translate-y-[-5px] duration-300">
            <div class="p-6 flex flex-col items-center">
              <div class="text-center mb-4">
                <i class="pi pi-print text-5xl text-primary-600" />
              </div>
              <h3 class="text-xl font-semibold mb-4 text-center">
                Fax Us
              </h3>
              <p class="text-center text-xs lg:text-xl xl:text-2xl mb-0">
                {{ formatPhoneNumberWithDashes(phoneNumbers.fax) }}
              </p>
            </div>
          </div>
        </div>
