...
<template>
  <div>
    ...
    <div class="prose prose-slate max-w-none">
      ...
      <p class="mb-6">
        <span class="italic">Business Associate Agreement (BA Agreement).</span> A Business Associate Agreement is a formal written contract between OHLaw and a HIPAA Covered Entity or Business Associate that requires OHLaw to comply with specific requirements related to protected health information (PHI).
        <br><span class="italic">Covered Entity.</span> A Covered Entity is a health plan, health care provider, or healthcare clearinghouse that must comply with the HIPAA Privacy Rule.
        <br><span class="italic">Personally Identifiable Information (PII).</span> PII includes all information which can be used to distinguish or trace an individual's identity, such as their name, social security number, biometric records, etc. alone, or when combined with other personal or identifying information which is linked or linkable to a specific individual, such as date and place of birth, mother's maiden name, etc.
        <br><span class="italic">Protected Health Information (PHI).</span> PHI includes all "individually identifiable health information" that is transmitted or maintained in any form or medium by a Covered Entity. Individually identifiable health information is any information that can be used to identify an individual and that was created, used, or disclosed in (a) the course of providing a health care service such as diagnosis or treatment, or (b) in relation to the payment for the provision of health care services.
      </p>
