<template>
  <div class="min-h-screen bg-slate-100 p-8">
    <div class="max-w-2xl mx-auto">
      <h1 class="text-3xl font-bold mb-6">Personalization Modal Test</h1>
      
      <Card class="mb-6">
        <template #title>
          <h2 class="text-xl font-semibold">Modal Testing</h2>
        </template>
      ...
      <Card v-if="personalizedValues">
        <template #title>
          <h2 class="text-xl font-semibold">Last Applied Values</h2>
        </template>
